		...
		plugins: [
			...
			viteStaticCopy({
				targets: [
					...
					{
						src: 'src/assets/images/PW-LOGO transparent.png',
						dest: 'assets/',
					},
					{
			...
			VitePWA({
				...
				workbox: {
					...
					runtimeCaching: [
						{
							urlPattern:
								/^https:\/\/fonts\.googleapis\.com\/.*/i, // Example for caching Google Fonts (this demo uses Google Roboto in the App.css)
							handler: 'CacheFirst',
							options: {
				...
				manifest: {
					...
					start_url:
						'https://0.0.0.0/ch5-react-ts-template/index.html',
					...
					description:
						'A Crestron CH5 project using React, Vite, and PWA features',
					theme_color: '#696969',
